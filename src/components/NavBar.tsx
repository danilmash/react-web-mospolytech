...
const NavBar: React.FC<NavBarProps> = ({ children }) => {
  ...
  const items: MenuProps["items"] = [
    {
      label: <NavLink to={HOME_ROUTE}>Home</NavLink>,
      key: "home-link",
    },
    {
      label: <NavLink to={FORM_ROUTE}>Form</NavLink>,
      key: "about-link",
    },
  ];
  ...
  if (isAuthenticated) {
    items.push(
      ...[
        {
          label: <NavLink to={TRANSACTION_ROUTE}>Developer</NavLink>,
          key: "developer-link",
        },
        {
          label: <NavLink to={TABLE_ROUTE}>Table</NavLink>,
          key: "table-link",
        },
        {
